...
def SignalRecovery(SignalPDF, ScrSignalPDF, SignalPDF_inj, BkgPDF, Ndata, llh_type='SignalSub', ntrials=200, npoints=50):
...
output = SignalRecovery(SignalPDF, SignalPDF_Scr, SignalPDF_inj, BkgPDF, np.sum(10* BurnSample), llh_type=llh)
